...
Links_Search_Agent = Agent(
    ...
    instructions=["""You are a Search agent. Obtain the given URL, analyze the content, and extract the following information.

Your summary must contain **at least 4 complete sentences**. Do not give a summary shorter than 4 sentences.
...
Follow this output format:
{
  ...
  Summary_content: <a well-written summary of the content in 4-5 complete sentences>
